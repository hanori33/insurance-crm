...
const INSURANCE_COMPANIES = [
  {
    ...
    faxType: 'auto',
    fax: '0505-021-3400',
    customerCenter: '1566-7711',
    pdf: '/insurance-forms/메리츠화재.pdf',
  },
  {
    name: 'DB손해보험',
    type: '손해보험',
    faxType: 'auto',
    fax: '0505-181-4862',
    customerCenter: '1588-0100',
    pdf: '/insurance-forms/DB손해보험금청구서.pdf',
  },
  {
    name: 'KB손해보험',
    type: '손해보험',
    faxType: 'auto',
    fax: '0505-136-6500',
    customerCenter: '1544-0114',
    pdf: '/insurance-forms/KB손해.pdf',
  },
  {
    name: '현대해상',
    type: '손해보험',
    faxType: 'auto',
    fax: '0507-774-6060',
    customerCenter: '1588-5656',
    pdf: '/insurance-forms/현대해상 청구.pdf',
  },
  {
    name: '한화손해보험',
    type: '손해보험',
    faxType: 'auto',
    fax: '0502-779-1004',
    customerCenter: '1566-8000',
    pdf: '/insurance-forms/한화손해.pdf',
  },
  {
    name: '흥국화재',
    type: '손해보험',
    faxType: 'auto',
    fax: '0504-800-0700',
    customerCenter: '1688-1688',
    pdf: '/insurance-forms/흥국화재.pdf',
  },
  {
    name: '롯데손해보험',
    type: '손해보험',
    faxType: 'auto',
    fax: '0507-333-9999',
    customerCenter: '1588-3344',
    pdf: '/insurance-forms/롯데손해.pdf',
  },
  {
    name: '삼성화재',
    type: '손해보험',
    faxType: 'auto',
    fax: '0505-161-1166',
    customerCenter: '1588-5114',
    pdf: '/insurance-forms/삼성화재.pdf',
  },
  {
    name: '하나손해보험',
    type: '손해보험',
...

  {
    ...
    faxType: 'auto',
    fax: '0505-161-6000',
    customerCenter: '1588-3114',
    pdf: '/insurance-forms/삼성생명.pdf',
  },
  {
    name: '한화생명',
    type: '생명보험',
    faxType: 'auto',
    fax: '0503-8863-6363',
    customerCenter: '1588-6363',
    pdf: '/insurance-forms/한화생명.pdf',
  },
  {
    name: '흥국생명',
    type: '생명보험',
    faxType: 'manual',
    fax: '',
    customerCenter: '1588-2288',
    pdf: '/insurance-forms/흥국생명.pdf',
  },
  {
    name: '교보생명',
    type: '생명보험',
    faxType: 'auto',
    fax: '0505-181-0033',
    customerCenter: '1588-1001',
    pdf: '/insurance-forms/교보청구서류.pdf',
  },
  {
  name: 'ABL생명',
  type: '생명보험',
  faxType: 'manual',
  fax: '',
  customerCenter: '1588-6500',
  pdf: '/insurance-forms/ABL 사고보험금청구서.pdf',
},
  {
  name: '하나생명',
  type: '생명보험',
...
export default function FaxClaimPage({ onBack }) {
  ...
  const selectedCompanyInfo = INSURANCE_COMPANIES.find(
  ...
  const found = INSURANCE_COMPANIES.find(
    (item) => item.name === name
  );
  ...
  if (found.faxType === 'manual') {
    setFaxNumber('');
  } else {
    setFaxNumber(found.fax || '');
  }
}
...
{selectedCompanyInfo?.faxType === 'manual' && (
  ...
  >
    📢 해당 보험사는 보험금 청구용 팩스번호를
    고객센터에서 발급받아야 합니다.
    <br />
    고객센터 : {selectedCompanyInfo.customerCenter}
    <br />
    발급받은 팩스번호를 직접 입력해주세요.
  </div>
)}

              <div style={styles.helpText}>
                ※ 보험사 연락처 페이지 데이터와 추후 연결 가능. 현재는 테스트용 기본 목록입니다.
              </div>
            </Card>
            ...
            <Card>
              ...
              <div style={styles.helpText}>
                PDF, JPG, PNG 파일을 여러 개 선택할 수 있습니다. 현재는 실제 업로드 없이 파일명만 이력에 저장됩니다.
              </div>
            ...
            <Card>
              ...
              <div style={styles.helpText}>
                ※ 실제 팩스 발송은 아직 하지 않습니다. 나중에 팝빌 / 바로빌 / 엔팩스 API 연결 시 발송 버튼을 추가할 수 있습니다.
              </div>
            </Card>
          </div>
        </div>
...
function Info({ label, value }) {
  return (
    <div>
      ...
      <div style={{ fontSize: 13, color: COLORS.text, fontWeight: 800, marginTop: 3 }}>
        {value || '-'}
      </div>
    </div>
  );
