...
function NodeBox({ node, isRoot }) {
  return (
    <div style={{
      ...
      <div>
        <div style={{ fontWeight: 700, fontSize: isRoot ? 15 : 13, color: COLORS.text }}>
          {node.name}
        </div>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <div style={{
        ...
        borderRadius: 12,
        padding: '8px 12px',
        boxShadow: '0 2px 10px rgba(124,92,252,0.10)',
        display: 'flex',
        ...
        <div style={{ fontSize: 11, fontWeight: 600, color: COLORS.text, marginTop: 4 }}>
          {node.name}
        </div>
